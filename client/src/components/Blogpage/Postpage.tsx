  ...
  if(location)
  {
    ...
    return (
      <div className="flex flex-col h-screen">
        <div className="flex flex-col bg-cover bg-gradient-to-b from-black to-purple-500 items-center">
          <div className="flex flex-col items-center w-9/12 h-auto mb-5 bg-white rounded-lg shadow-lg">
